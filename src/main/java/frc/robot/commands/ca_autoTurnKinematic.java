...
public class ca_autoTurnKinematic extends CommandBase {
  ...
  public void initialize() {
    ...
    System.out.println("Time: " + timer.get() + " Velocity: " + 0 + " Omega: " + 0 +
        " Angle: " + Math.toDegrees(dt.zSimAngle) + " AngleTarget: " + eAngle + " LeftSpeed: " + 0 + " RightSpeed: "
        + 0);
  }
  ...
  public void execute() {
    ...
    System.out.println("Time: " + timer.get() + " Velocity: " + chassisSpeed + " Omega: " + comega +
        " Angle: " + Math.toDegrees(dt.zSimAngle) + " AngleTarget: " + eAngle + " LeftSpeed: " + leftSpeed
        + " RightSpeed: " + rightSpeed + " Error: " + error);
  }
