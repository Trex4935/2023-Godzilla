...
public class TrajectoryContainer {
        ...
        public static final TrajectoryConfig trajectoryConfig = new TrajectoryConfig(
                        AutoMovementConstraints.autodtMaxSpeed, AutoMovementConstraints.dtmaxaccel);
        ...
        public static final Double trajFrontEnd = 1.0; // goes on platform without encoders
        ...
        public static final Double trajMobilityEnd = Units.inchesToMeters(135); //Go to mobility 139.5, 95
        ...
        public static final Double trajPieceEnd = Units.inchesToMeters(195);// 192-187-183-39
        ...
        public static final Double trajPieceSideEnd = Units.inchesToMeters(16);
        public static final Trajectory trajectoryPieceSide = TrajectoryGenerator.generateTrajectory(
                        new Pose2d(0, 0, new Rotation2d(0)),
                        List.of(),
                        new Pose2d(0, trajPieceSideEnd, Rotation2d.fromDegrees(0)),
                        trajectoryConfig);
        ...
        // public static final Trajectory trajGoToChargeStation =
        // TrajectoryGenerator.generateTrajectory(
        // new Pose2d(0.0,0.0,new Rotation2d(0)),
        // List.of(),
        // new Pose2d(0.0,0.0, Rotation2d.fromDegrees(0)),
