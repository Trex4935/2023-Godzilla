...
public class Drivetrain extends SubsystemBase {
    ...
    //Takes Axis values of Joysticks to set the speed of the robot
    public void driveWithJoysticks(Joystick joystick1, Joystick joystick2) {
        diffdrive.tankDrive(joystick1.getRawAxis(JoystickAxis.joystickAxis), joystick2.getRawAxis(JoystickAxis.joystickAxis));
