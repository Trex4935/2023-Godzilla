...
public class cg_autoScore extends SequentialCommandGroup {
  ...
  public cg_autoScore(Drivetrain drivetrain, Arm arm, Gripper gripper) {
    ...
    addCommands(
        ...
        /* Replace new ca_autoTrajectoryKinematicWithGyro(drivetrain, TrajectoryContainer.trajectoryMobility,
            TrajectoryContainer.trajMobilityEnd, 0.0), // Moves to game piece */
        // Replace new ca_autoDriveStraightTrajKinGyroEncPID(drivetrain, TrajectoryContainer.trajectoryMobility, TrajectoryContainer.trajMobilityEnd, 0.0) // Moves for mobility points
