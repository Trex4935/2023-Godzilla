...
public class cg_autoDoubleScore extends SequentialCommandGroup {
  ...
  public cg_autoDoubleScore(Drivetrain drivetrain, Arm arm, Gripper gripper) {
    ...
    addCommands(
        ...
        new ca_autoTrajectoryKinematic(drivetrain, TrajectoryContainer.trajectoryFront, TrajectoryContainer.trajFrontEnd), // Moves to game piece
        ...
        new ca_setArmPosition(ArmPosition.CARRY), // Resets arm to default position
        new ca_autoTrajectoryKinematic(drivetrain, TrajectoryContainer.trajectoryBack, TrajectoryContainer.trajBackEnd), // Moves to scoring area
        ...
        new cm_GripperOpen(gripper), // Drops the game piece
        new ca_setArmPosition(ArmPosition.CARRY), // Resets arm to default position
        new ca_autoTrajectoryKinematic(drivetrain, TrajectoryContainer.trajectoryMobility, TrajectoryContainer.trajMobilityEnd) // Moving to get mobility points
